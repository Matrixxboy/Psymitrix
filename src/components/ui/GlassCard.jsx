...
const GlassCard = ({ children, className = '' }) => {
  ...
  return (
    <div
      ...
      className={`relative rounded-2xl shadow-lg border border-white/30 dark:border-white/10 bg-white/20 dark:bg-white/5 backdrop-blur-2xl transition-transform duration-200 [transform-style:preserve-3d] hover:shadow-2xl ${className}`}
